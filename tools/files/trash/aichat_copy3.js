...
class AIChat extends HTMLElement {
    ...
    async processPastedContent(text) {
        ...
        this.availableCodeTypes.clear();
        // ✅ FIX: Require newlines to prevent matching backticks inside code content
    ...
    renderHistory() {
        ...
        displayMessages.forEach(msg => {
            ...
            // ✅ FIX: Require newlines - prevents matching ``` inside code content
            const codeBlockRegex = /```(\w*)\s*\n([\s\S]*?)\n\s*```/g;
            let match;
            let lastIndex = 0;
            ...
            // ✅ Role prefix as separate elements (security)
