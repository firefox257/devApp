    ...
    displayMessages.forEach(msg => {
      ...
      if (shouldDisplay) {
        if (!containsCode) {
          ...
          outerP.textContent = `${msg.role === 'user' ? '👤' : '🤖'}: ${msg.content}`;
          rawTextOutputDiv.appendChild(outerP);
        } else {
          if (fragment.firstChild && fragment.firstChild.tagName === 'P') {
            fragment.firstChild.textContent = `${msg.role === 'user' ? '👤' : '🤖'}: ${fragment.firstChild.textContent}`;
            ...
            roleInfo.textContent = `${msg.role === 'user' ? '👤' : '🤖'}: `;
...
<div id="mainChatTool">
  ...
  <div class="input-area-wrapper">
    <div id="textInput" contenteditable="true" placeholder="Type your message..."></div>
