...
// 🎨 Material Icons Semantic Colors
const ICON_COLORS = {
    primary: '#007bff',
    secondary: '#6c757d',
    destructive: '#dc3545',
...
class AIChat extends HTMLElement {
    ...
    // 🔽 Helper to attach expand/collapse toggle to code blocks
    ...
    // 🔽 Simple hash for persisting expand state (optional)
    _simpleHash(str) {
        let hash = 0;
    ...
    renderHistory() {
        ...
        displayMessages.forEach(msg => {
            ...
            while ((match = codeBlockRegex.exec(msg.content)) !== null) {
                ...
                // 🔽 UPDATED: Code block with expand/collapse - copy button always visible
                const codeBlockContainer = document.createElement('div');
                codeBlockContainer.classList.add('code-block-container', 'collapsed');
                    ...
                    if (line.startsWith('')) {
                        ...
                        try {
                            ...
                            if (content) {
                                ...
                                // 🔽 UPDATED: Apply toggle to new code blocks during streaming
    ...
    render() {
        this.shadowRoot.innerHTML = `
            <style>
                ...
                /* 🔽 UPDATED: Collapsible code block styles - copy button ALWAYS visible */
                ...
                /* ✅ REMOVED: .code-block-container.collapsed .copy-button { display: none; } */
                .expand-button {
                    background: none;
                    border: none;
                    color: #007bff;
