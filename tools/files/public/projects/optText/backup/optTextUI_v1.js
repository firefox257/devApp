...
export function createOptTextDOM(originalClass, originalId, placeholder = '') {
    const html = `
        <div class="opt-text-container-wrapper ${originalClass || ''}" ${originalId ? `id="${originalId}"` : ''}>
            ...
            <div class="opt-text-loading hidden">
                ...
                <div class="opt-text-loading-bar">
                    <div class="opt-text-loading-bar-fill"></div>
                </div>
            </div>
            <div class="opt-text-perf-stats">
                Visible: <span data-ref="visible">0</span><br>
                FPS: <span data-ref="fps">60</span><br>
                Render: <span data-ref="render">0</span>ms
            </div>
            <div class="opt-text-scrollbar vertical">
                <div class="opt-text-scrollbar-thumb"></div>
            </div>
            <div class="opt-text-scrollbar horizontal">
                <div class="opt-text-scrollbar-thumb"></div>
            </div>
