...
additionManager.register({
	...
	init: (api, container, dataManager) => {
		...
		// ✅ FIX: Use native Object.defineProperty directly to avoid the lifecycle timing crash 
		// where container.defineProperty is undefined during the auto-init phase.
