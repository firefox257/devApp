...
// Minimal class structure for extension data access.
// Internal editor logic uses direct module variables (unchanged).
...
export class TextContext {
  constructor(name, initialLines = [''], options = {}) {
    ...
    // NOTE: `lines` will be replaced by the editor's internal array reference
